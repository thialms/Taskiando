...
const AddTask = () => {
    ...
    return (
        <section>
            ...
            <form className="mt-10 font-poppins w-full max-w-md">
                ...
                <div className="relative z-10 bg-white rounded-t-3xl mt-10 min-h-screen">
                    ...
                    <div className="flex justify-center">
                        <div className="grid grid-cols-2 mt-5 ml-14">
                            <div>
                                <label 
                                className="block opacity-50">
                                    ...
                                    <input 
                                    type="time" 
                                    className="py-4 pl-2 text-xl font-semibold border-b-2 border-gray-200" 
                                    name="taskstarttime"
                                    >
                                    </input>
                                </label>
                    ...
                    <div className="flex justify-center mt-20">
                        <button 
                        type="submit" 
                        className="w-80 p-4 mt-4 rounded-full bg-gradient-to-r from-task-purple to-task-darkpurple text-white">Criar Tarefa</button>
                    </div>
